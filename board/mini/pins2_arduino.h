 ...
 *  This is file for Arduino Mini (Atmega328). 
 *  There is no change compared to Arduino Uno (standard); Pins DP18 and DP19
 *  are marked A4 and A5 on the Arduino Mini.
 *
...
enum GPIO_pin_enum
{
	...
	DP18 = GPIO_MAKE_PINCODE(MYPORTC,4),	// A4
	DP19 = GPIO_MAKE_PINCODE(MYPORTC,5),	// A5
};

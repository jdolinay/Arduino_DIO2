...
// ===========================================================================
//
// ARDUINO2_PREFER_SPEED - User can define this value before including arduino2.h
...
// switch to 0.
//
#ifndef ARDUINO2_PREFER_SPEED
	#define		ARDUINO2_PREFER_SPEED	1
#endif


//
// ARDUINO2_IOREGS_ABOVEFF - set to 1 if the Atmega MCU used for this Arduino variant has
// some GPIO registers at address higher than 0xff (e.g. Atmega2560 in Arduino Mega).
...
// If not sure, set to 1 (this is always safe)
//
#define	  ARDUINO2_IOREGS_ABOVEFF	0
...
// ====================================================================
// Helper for converting normal Arduino pin number to our pin code.
// So that the users ca  n still use their integer pin numbers.
// ====================================================================
